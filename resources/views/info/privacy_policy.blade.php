...
<article>
    <section>
        ...
        <ul>
            ...
            <li>メールアドレスから作成される匿名化された (「ハッシュ」とも呼ばれる) 文字列は、お客様が Gravatar サービスを使用中かどうか確認するため同サービスに提供されることがあります。同サービスのプライバシーポリシーは<a href="https://kakky-blog.com/privacy_policy" class="text_link">https://kakky-blog.com/privacy_policy</a>にあります。コメントが承認されると、プロフィール画像がコメントとともに一般公開されます。</li>
        </ul>
    </section>
    <section>
        <h3>Cookie</h3>
