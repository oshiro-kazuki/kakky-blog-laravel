            ...
            <form action="{{ route('news_input.post') }}" method="post" enctype="multipart/form-data">
                ...
                <section id="news_input_form_input">
                    ...
                    <div class="news_input_title">
                        <label>タイトル</label>
                        <input id="news_input_title" type="text" name="news_input_title" maxlength="210" value="{{ old('news_input_title') }}" placeholder="タイトルを入力してください(最大20文字)">
                    ...
                    <div class="news_input_content">
                        <label>本文</label>
                        <textarea id="news_input_content" type="text" name="news_input_content" maxlength="210" size="140" cols="30" rows="10" value="{{ old('news_input_content') }}" placeholder="本文を入力してください(最大140文字)"></textarea>
